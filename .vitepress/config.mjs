...
export default defineConfig({
  ...
  head: [
    ...
    // Google Analytics 4
    ['script', { async: '', src: 'https://www.googletagmanager.com/gtag/js?id=G-ESBTGSLNY6' }],
    ['script', {}, `
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'G-ESBTGSLNY6', {
  ...
  themeConfig: {
    ...
    sidebar: [],
    footer: {
      message: 'Kakobuy Spreadsheet - Your trusted resource for cross-border e-commerce | <a href="/sitemap.xml">Sitemap</a>',
